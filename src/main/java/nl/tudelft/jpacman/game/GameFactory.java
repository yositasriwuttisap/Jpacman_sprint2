...
public class GameFactory {
     ...
     */
    public Game createSinglePlayerGame(Level level, PointCalculator pointCalculator, String currentTheme) {
        return new SinglePlayerGame(playerFactory.createPacMan(currentTheme), level, pointCalculator);
    }
